...
<section id="home-blog">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>Actualidad inmobiliaria <a href="#">Ver todas las noticias</a></h2>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="nota-blog">
                    <div class="nota-blog-bg" style="background-image:url(<?php echo get_template_directory_uri() . '/img/nota1.jpg' ?>);"></div>
                    <h3>Como invertir de manera acertada
                        en un mercado tan cambiante.</h3>
                    <div class="nota-ver-mas">Seguir leyendo</div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="nota-blog">
                    <div class="nota-blog-bg" style="background-image:url(<?php echo get_template_directory_uri() . '/img/nota2.jpg' ?>);"></div>
                    <h3>El valor de las propiedades y el
                        aumento de los impuestos.</h3>
                    <div class="nota-ver-mas">Seguir leyendo</div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="nota-blog">
                    <div class="nota-blog-bg" style="background-image:url(<?php echo get_template_directory_uri() . '/img/nota3.jpg' ?>);"></div>
                    <h3>10 causas del aumento en los
                        alquileres.</h3>
                    <div class="nota-ver-mas">Seguir leyendo</div>
                </div>
            </div>
